...
public class WXShare {
    public static final String APP_ID = "wxa83adf38db5827e6";
     ...
     * type:0表示朋友圈  1表示好友会话
     */
    public void share(Context context,String url,String title,String content,int type) {
